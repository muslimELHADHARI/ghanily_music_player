...
import mc_player.models.Languages;
...
public class ItemMusic extends javax.swing.JPanel {
    ...
    private final Music_Model data;
    ...
    public void setPlay(boolean play) {
        ...
        if (play) {
            lbIcon.setText("");
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/mc_player/icons/playing.png")));
            fixDisplay();
...
if(Languages.isContainsArabic(data.getName())){
        lbText.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        }
        else{
        lbText.setFont(new java.awt.Font("Sylfaen", 1, 14)); // NOI18N
        }
}
    public ItemMusic(Music_Model data) {
        this.data = data;
        initComponents();
        setOpaque(false);
